...
from setpred4re import SetPred4RE
...
if __name__ == '__main__':
    ...
    data_arg.add_argument('--test_file', type=str, default="./new_test.json")
    ...
    data_arg.add_argument('--bert_directory', type=str, default="EMBEDDIA/sloberta")
    ...
    learn_arg.add_argument('--max_grad_norm', type=float, default=3)
    ...
    test_tokens = data.orig_tokens

    print(trainer.predict(test, test_tokens, data.relational_alphabet.get_instance))